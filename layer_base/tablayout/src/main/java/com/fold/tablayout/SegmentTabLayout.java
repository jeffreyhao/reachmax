...
import com.fold.tablayout.listener.OnTabSelectListener;
import com.fold.tablayout.utils.FragmentChangeManager;
import com.fold.tablayout.utils.UnreadMsgUtils;
import com.fold.tablayout.widget.MsgView;
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            // 修改margin以后会改变indicator rect的宽度，等tipView measure好以后重新计算rect
