...
public class ColorScheme implements Serializable {
    ...
    private int daySelectBorderTextColor = 0xFFFFFFFF;
    private int dayNormalBackgroundColor = Color.TRANSPARENT;
    private int dayInvalidBackgroundColor = Color.TRANSPARENT;
    private int daySelectBackgroundColor = 0xCCE75051;
    private int daySelectBorderBackgroundColor = 0xFFE75051;
    ...
    @ColorInt
    public int daySelectBorderTextColor() {
        return daySelectBorderTextColor;
    }

    public ColorScheme daySelectBorderTextColor(@ColorInt int color) {
        this.daySelectBorderTextColor = color;
        return this;
    }
    ...
    public ColorScheme daySelectBorderBackgroundColor(@ColorInt int color) {
        this.daySelectBorderBackgroundColor = color;
        return this;
    }

    @ColorInt
    public int daySelectBorderBackgroundColor() {
        return daySelectBorderBackgroundColor;
    }
}
