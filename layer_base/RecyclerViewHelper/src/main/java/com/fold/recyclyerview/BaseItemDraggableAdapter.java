...
import com.fold.recyclyerview.callback.ItemDragAndSwipeCallback;
import com.fold.recyclyerview.listener.OnItemDragListener;
import com.fold.recyclyerview.listener.OnItemSwipeListener;
        ...
        if (mDragOnLongPress) {
            ...
            mOnToggleViewTouchListener = new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    if (event.getAction() == MotionEvent.ACTION_DOWN && !mDragOnLongPress) {
                        if (mItemTouchHelper != null && itemDragEnabled) {
                            mItemTouchHelper.startDrag((RecyclerView.ViewHolder) v.getTag(R.id.BaseQuickAdapter_viewholder_support));
                        }
                        return true;
