...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setTextOrGone(@IdRes int viewId, CharSequence text){
        TextView view = getView(viewId);
    ...
    public BaseViewHolder setTextColor(@IdRes int viewId, ColorStateList textColor) {
        TextView view = getView(viewId);
        view.setTextColor(textColor);
        return this;
    }
     ...
     * @return The BaseViewHolder for chaining.
     * @Deprecated Please use {@link #addOnClickListener(int)} (int)} (adapter.setOnItemChildClickListener(listener))}
     */
    @Deprecated
