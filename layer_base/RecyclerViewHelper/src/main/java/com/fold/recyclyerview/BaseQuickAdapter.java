...
import com.fold.recyclyerview.animation.AlphaInAnimation;
import com.fold.recyclyerview.animation.BaseAnimation;
import com.fold.recyclyerview.animation.ScaleInAnimation;
import com.fold.recyclyerview.animation.SlideInBottomAnimation;
import com.fold.recyclyerview.animation.SlideInLeftAnimation;
import com.fold.recyclyerview.animation.SlideInRightAnimation;
import com.fold.recyclyerview.entity.IExpandable;
import com.fold.recyclyerview.loadmore.LoadMoreView;
import com.fold.recyclyerview.loadmore.SimpleLoadMoreView;
import com.fold.recyclyerview.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public interface OnItemLongClickListener<T> {
         ...
         * @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemLongClick(BaseQuickAdapter<T, ? extends BaseViewHolder> adapter, View view, T item, int position);
    }
    ...
    public interface OnItemClickListener<T> {
         ...
         */
        void onItemClick(BaseQuickAdapter<T, ? extends BaseViewHolder> adapter, View view, T item, int position);
    }

    public interface RefreshDataListener {
        void refreshData(String bid);
    }
     ...
     */
    @Override
    public void onBindViewHolder(K holder, int index) {
        int position = Math.toIntExact(getItemId(index));
        ...
        switch (viewType) {
            ...
            case FOOTER_VIEW:
                break;
            default:
                int itemIndex = position - getHeaderLayoutCount();
                T item = getItem(itemIndex);
                holder.itemView.setTag(R.id.BaseQuickAdapter_item_view_tag, item);
                holder.itemView.setTag(R.id.BaseQuickAdapter_item_view_index, itemIndex);
                convert(holder, item, itemIndex);
                break;
        }
    }
    ...
    private void bindViewClickListener(final BaseViewHolder baseViewHolder) {
        ...
        if (getOnItemClickListener() != null) {
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Object item = view.getTag(R.id.BaseQuickAdapter_item_view_tag);
                    setOnItemClick(v, (T) item, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
            });
        }
        if (getOnItemLongClickListener() != null) {
            view.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    Object item = view.getTag(R.id.BaseQuickAdapter_item_view_tag);
                    return setOnItemLongClick(v, (T) item,baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
            });
        }
    }
     ...
     * @param position
     */
    public void setOnItemClick(View v, T item, int position) {
        getOnItemClickListener().onItemClick(BaseQuickAdapter.this, v, item, position);
    }
     ...
     * @return
     */
    public boolean setOnItemLongClick(View v, T item, int position) {
        return getOnItemLongClickListener().onItemLongClick(BaseQuickAdapter.this, v, item, position);
    }
...
//            subItemCount += list.size();
    ...
    public void refreshAdapter(String bid) {
        if (null != refreshDataListener) {
            refreshDataListener.refreshData(bid);
        }
    }
     ...
     * ⚠️ 注意使用前提：
     * <br>
     *      不要使用： {@link RecyclerView#setAdapter(RecyclerView.Adapter)}  ❌
     * <br>
     *      要使用：  {@link BaseQuickAdapter#bindToRecyclerView(RecyclerView)}  ✅
     */
