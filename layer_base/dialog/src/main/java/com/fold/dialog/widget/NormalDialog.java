package com.fold.dialog.widget;
...
import com.fold.dialog.utils.CornerUtils;
import com.fold.dialog.widget.internal.BaseAlertDialog;
...
public class NormalDialog extends BaseAlertDialog<NormalDialog> {
    ...
    public View onCreateView() {
        ...
        /** btns */
        mTvBtnLeft.setLayoutParams(new LinearLayout.LayoutParams(0, dp2px(52), 1));
        ...
        mTvBtnMiddle.setLayoutParams(new LinearLayout.LayoutParams(0, dp2px(52), 1));
        ...
        mTvBtnRight.setLayoutParams(new LinearLayout.LayoutParams(0, dp2px(52), 1));
    ...
    public void setUiBeforShow() {
        ...
        if (mStyle == STYLE_ONE) {
            ...
            mTvContent.setMinHeight(dp2px(88));
