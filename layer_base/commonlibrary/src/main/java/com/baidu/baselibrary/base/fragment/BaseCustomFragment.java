...
* @desc fragment 基类
*/
public abstract class BaseCustomFragment<P extends BasePresenter> extends CustomFragment {
    ...
    public ViewGroup onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mRootView != null) {
            ...
            this.mRootView = createRootView(inflater, container, savedInstanceState);
            setData();
        }
        return mRootView;
    }

    protected abstract ViewGroup createRootView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState);
    ...
    public static <T extends BaseCustomFragment> T newInstance(Class<T> c, Bundle extras) {
        T instance = null;
        try {
    ...
    protected void initLoadingView(){
        if(autoAddLoadingView() && (
                mRootView instanceof RelativeLayout
                        || mRootView instanceof FrameLayout)){
    ...
    public void showActivityEmptyView(boolean show){
        if(mActivity != null && mActivity instanceof BaseActivity) {
            ((BaseActivity<?, ?>) mActivity).showEmptyView(show);
        }
    }
