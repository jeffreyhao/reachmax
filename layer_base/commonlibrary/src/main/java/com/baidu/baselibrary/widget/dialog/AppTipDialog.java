...
public class AppTipDialog extends LoggerDialogFragment {
     ...
     */
    public static AppTipDialog newInstance(String title, String content, String cancelValue, String confirmValue, boolean isNightMode) {
        ...
        AppTipDialog tipDialog = new AppTipDialog();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.common_dialog_app_tip, container, false);
    }
