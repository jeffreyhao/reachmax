...
public abstract class BaseListCustomFragment<T, P extends BasePresenter<?>>
        extends BindingCustomFragment<CommonListLayoutBinding, P>
    ...
    public void showLoading(boolean show) {
        ...
        if (state == RefreshState.PullDownToRefresh
                ...
                || state == RefreshState.PullUpToLoad
