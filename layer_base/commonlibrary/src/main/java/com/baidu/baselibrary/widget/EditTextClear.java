...
/**
 * @author: yuhaibo
 * @time: 2018/7/11 下午3:21.
 * 
 * Description:
 */
public class EditTextClear extends androidx.appcompat.widget.AppCompatEditText {
    /**
     * 步骤1：定义左侧搜索图标 & 一键删除图标
     */
    ...
    private void setClearIconVisible(boolean visible) {
        setCompoundDrawablesRelativeWithIntrinsicBounds(null, null, visible ? clearDrawable : null, null);
    }
