package com.baidu.baselibrary.util.storage;
...
public class DataCleanManager {
    ...
    public static void cleanInternalCache(Context context) {
        ...
        ALog.textSingle("DataCleanManager", "cleanInternalCache", "clear cacheDir: " + cacheDir.getAbsolutePath());
    ...
    public static void cleanFiles(Context context) {
        ...
        ALog.textSingle("DataCleanManager", "cleanFiles", "clear filesDir: " + filesDir.getAbsolutePath());
    ...
    public static void cleanExternalCache(Context context) {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            ...
            if(extCacheDir != null){
                ALog.textSingle("DataCleanManager", "cleanExternalCache", "clear extCacheDir: " + extCacheDir.getAbsolutePath());
                deleteFilesByDirectory(extCacheDir);
            }
        }
    }
