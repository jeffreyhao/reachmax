...
public class DatePickerDialog extends AppCompatDialogFragment implements
    ...
    private static SimpleDateFormat MONTH_FORMAT = new SimpleDateFormat("MMM", Locale.ENGLISH);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.mdtp_date_picker_dialog_v2, container, false);
        ...
        view.findViewById(R.id.mdtp_ok).setOnClickListener(v -> {
            tryVibrate();
            notifyOnDateListener();
            dismiss();
        });

        view.findViewById(R.id.mdtp_cancel).setOnClickListener(v -> {
            tryVibrate();
