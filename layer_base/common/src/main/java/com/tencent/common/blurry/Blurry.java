package com.tencent.common.blurry;
...
import com.tencent.common.blurry.internal.Blur;
import com.tencent.common.blurry.internal.BlurFactor;
import com.tencent.common.blurry.internal.BlurTask;
import com.tencent.common.blurry.internal.Helper;
...
public class Blurry {
    ...
    public static class BitmapComposer {
        ...
        public void into(final ImageComposer.ImageComposerListener imageComposerListener) {
            factor.width = bitmap.getWidth();
            factor.height = bitmap.getHeight();
...
//      if (async) {
            BlurTask task = new BlurTask(context, bitmap, factor, new BlurTask.Callback() {
                @Override
                public void done(BitmapDrawable drawable) {
                    imageComposerListener.onImageReady(drawable);
                }
            });
            task.execute();
//      } else {
